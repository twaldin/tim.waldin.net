...
export const MODULES: ModuleSpec[] = [
  {
    ...
    desc: 'End-to-end commission automation. Reads the board, prioritises Mithril by colour, handles crouch-mining and the drill reset bug, and surfaces progress on a live in-game HUD.',
    tags: ['Mithril priority', 'Crouch mining', 'Drill reset fix', 'Live HUD'],
  },
  {
    cat: 'Mining',
    name: 'Gemstone Macro',
    desc: 'Per-gem targeting for the full gemstone set — Ruby, Jade, Sapphire, Amethyst, Topaz, Opal, Jasper and more — with on-floor route rendering and optional enemy clearing.',
    tags: ['Per-gem targeting', 'Route rendering', 'Index numbers', 'Gemstone HUD'],
  },
  {
    cat: 'Combat',
    name: 'Kill Bot',
    desc: 'Configurable combat assist with tunable range, FOV and yaw/pitch curves. Auto-clicker with CPS bounds, legit-mode rotations and ESP that can see through walls.',
    tags: ['Range & FOV', 'Yaw / pitch tuning', 'Auto-clicker', 'ESP · through-walls'],
  },
  {
    cat: 'Misc',
    name: 'Stash Crafter',
    desc: 'Hands-free stash crafting driven by an item-name filter and adjustable click CPS. Set the target and let the client clear the queue while you do something else.',
    tags: ['Item filter', 'Click CPS', 'Fully unattended'],
  },
  {
    cat: 'Misc',
    name: 'Spotify Integration',
    desc: 'A now-playing HUD that renders your current track and album art in-game so you never have to alt-tab. Scales cleanly with the rest of your GUI layout.',
    tags: ['Now-playing HUD', 'Album art', 'Layout-aware scaling'],
  },
  {
    cat: 'Utility',
    name: 'X-Ray & Utilities',
    desc: 'Gemstone X-Ray with per-type visibility, Full Bright, Nick Hider, route rendering, LineToWaypoint and Galatea shard-route support — the quality-of-life layer underneath it all.',
    tags: ['Per-gem X-Ray', 'Full Bright', 'Nick Hider', 'LineToWaypoint'],
  },
];
