...
echo ""
typewriter "${PURPLE}1. harness${RESET}"
...
typewriter "${PURPLE}2. hone${RESET}"
...
typewriter "${PURPLE}4. agentelo${RESET}"
typewriter "   ${WHITE}pairwise Bradley-Terry MLE rating system benchmarking AI coding agents across CLI harnesses${RESET}"
...
typewriter "${PURPLE}5. term site${RESET}"
...
typewriter "${PURPLE}6. trade-up-bot${RESET}"
typewriter "   ${WHITE}full-stack market arbitrage platform for CS2 trade-up contracts${RESET}"
typewriter "   ${BLUE}tech stack:${RESET} TypeScript, React, Express, PostgreSQL, Redis"
typewriter "   ${DIM}type ${BOLD}\"trade-up-bot\" to view info and navigate${RESET}"
echo ""

typewriter "${PURPLE}7. studyspot${RESET}"
typewriter "   ${WHITE}co-founded AI study platform — RAG + Claude answering questions from your course materials${RESET}"
typewriter "   ${BLUE}tech stack:${RESET} Next.js, Cloudflare Workers, pgvector, Claude API"
typewriter "   ${DIM}type ${BOLD}\"studyspot\" to view info and navigate${RESET}"
echo ""

typewriter "${PURPLE}8. stm32 games${RESET}"
typewriter "   ${WHITE}complete snake game in bare-metal C on a microcontroller with lcd screen.${RESET}"
...
typewriter "   ${BLUE}tools:${RESET} zsh, raw nvim (native vim.pack), tmux, ghostty, etc"
